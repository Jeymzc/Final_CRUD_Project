...
public class CustomerForm extends JFrame {
    ...
    public CustomerForm() {
        ...
        JLabel lblInfo = new JLabel("Cadang, James Paul T. - BSIT 3A");
        lblInfo.setBounds(60, 343, 262, 25);
        getContentPane().add(lblInfo);
        
        CustomerJeymz jeymz = new CustomerJeymz();
        ...
        btnLoad.addActionListener(e -> {
            try {
                List<Customer> list = jeymz.getAllCustomers();
                txtOutput.setText("");
                for (Customer c : list) {
